      ...
      <section id="cart_items">
        <div className="container">
          ...
          <div className="payment-options">
            <span>
              <label htmlFor='r1'><input type="radio" name="payment_option" id='r1' value="Direct Bank Transfer"/> Direct Bank Transfer</label>
            </span>
            <span>
              <label htmlFor='r2'><input type="radio" name="payment_option" id='r2' value="Check Payment"/> Check Payment</label>
            </span>
            <span>
              <label htmlFor='r3'><input type="radio" name="payment_option" id='r3' value="Paypal"/> Paypal</label>
            </span>
